...
echo "   qemu-system-x86_64 -kernel target/i386-osdev-rust/release/kernel -m 512M"
echo ""
echo "2. With VGA output:"
echo "   qemu-system-x86_64 -kernel target/i386-osdev-rust/release/kernel -m 512M -nographic"
echo ""
...
timeout 5 qemu-system-x86_64 -kernel target/i386-osdev-rust/release/kernel -m 512M -nographic || echo "✅ Test completed successfully!"